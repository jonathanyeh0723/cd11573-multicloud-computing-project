    ...
    "environment": [
      {
        ...
        "value": "udacity-jonathan-azure-sql"
      },
      {
        "name": "AZURE_DOTNET_APP",
        "value": "udacity-jonathan-azure-dotnet-app"
      }
    ],
    "portMappings": [
      {
...
resource "aws_s3_bucket" "example" {
  bucket = "udacity-jonathan-aws-s3-bucket"

  tags = {
    Name        = "udacity-jonathan-aws-s3-bucket"
    Environment = "Dev"
  }
}

resource "aws_dynamodb_table" "udacity-jonathan-aws-dynamodb" {
  name           = "udacity-jonathan-aws-dynamodb"
